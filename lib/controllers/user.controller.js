...
var getUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, user_repositories_1.getUserRepo)(userId)];
            case 2:
                user = _a.sent();
                if (user) {
...
var createUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, user_repositories_1.createUserRepo)(user)];
            case 2:
                success = _a.sent();
                if (success) {
                    res.status(200).json({ "data": user });
...
var updateUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedUser, success, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, user_repositories_1.updateUserRepo)(updatedUser.uid, updatedUser)];
            case 2:
                success = _a.sent();
                if (success) {
...
var deleteUserController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, user_repositories_1.deleteUserRepo)(userId)];
            case 2:
                success = _a.sent();
                if (success) {
